...
async function connectToWA() {
  ...
  console.log("Connecting FIXO_XMD💀");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("FIXO_XMD💀 installed successful ✅");
      console.log("FIXO_XMD💀 connected to whatsapp ✅");

      let up = `FIXO_XMD💀 connected successful ✅`;
